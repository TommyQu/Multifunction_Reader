...
public class MagOnlineShelf {

	public MagOnlineShelf(JMenuItem online_MagOnlineShlef) {
		// TODO Auto-generated constructor stub
		online_MagOnlineShlef.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				LoadOnlineShelf loadOnlineShelf=new LoadOnlineShelf(frame.MainFrame.getLoginName().getText());
				bookshelf=loadOnlineShelf.getLlist();
				...
				jComboBox.addItemListener(new ItemListener() {
					...
					public void itemStateChanged(ItemEvent e) 
					{
						...
						if(e.getStateChange() == ItemEvent.SELECTED)
						{
							...
							LoadOnlineCategory loadOnlineCategory=new LoadOnlineCategory(bookshelf);
							for(int i=0;i<loadOnlineCategory.getOnlineshelfJTextArea().size();i++)
							{
								JCheckBox jCheckBox=new JCheckBox();
								jCheckBox.setText(loadOnlineCategory.getOnlineshelfJTextArea().get(i).getText());
				...
				delbookshelf.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (result == JOptionPane.YES_OPTION) 
						{
							...
							{
								DelOnlineShelf delOnlineShelf=new DelOnlineShelf(jComboBox.getSelectedItem().toString());
							}
						}
